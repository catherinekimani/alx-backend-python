...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_url(self, mock_org) -> None:
        ...
        self.assertEqual(
            github_org_client._public_repos_url, payload["repos_url"])
    ...
    def test_has_license(
        self, repo, license_key, expected_result
    ) -> None:
        """ test_has_license """
        github_org_client = GithubOrgClient("google")
        self.assertEqual(
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """ setUpClass for integration testing """
    ...
    def tearDownClass(cls):
        """ implement tearDownClass """
        cls.get_patcher.stop()

    def test_public_repos(self):
        """ implement test_public_repos test """
        github_org_client = GithubOrgClient("google")
        self.assertEqual(github_org_client.public_repos(), self.expected_repos)

    def test_public_repos_with_license(self):
        """ implement test_public_repos_with_license test """
        github_org_client = GithubOrgClient("google")
        self.assertEqual(
